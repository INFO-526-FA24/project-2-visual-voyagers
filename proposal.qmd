...
-   Models Explored
    ...
    -   Visualizations are done based on three questions which assess classification models
...
-   Future Work
    ...
    -   Discuss how we can improve on the parameters of each model

    -   Discuss what other additional models can be studied about to
